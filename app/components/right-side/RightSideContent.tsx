  ...
  return (
    <div className="fixed ml-[900px] pt-3 flex flex-col gap-5  text-white">
      <div className="flex rounded-full ">
        <label
          htmlFor="searchbox"
          className="bg-slate-800 flex items-center   rounded-l-full rounded-r-none px-6"
        >
      ...
      <section className="h-[160px] space-y-3 w-[340px] p-4 bg-slate-800 rounded-xl">
        ...
        <Button className="text-base transition duration-200 hover:bg-blue-600  hover:bg-opacity-80 bg-blue-500 px-10  h-8 rounded-full ">
          Subscribe
        </Button>
      </section>
      <section className="h-[160px] space-y-3 w-[340px] p-4 bg-slate-800 rounded-xl">
