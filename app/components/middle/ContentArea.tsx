      ...
      <div className="">
        ...
        <div className="flex h-32 flex-col">
          ...
          <div className="grid grid-cols-2 grid-rows-1 h-full ">
            <Button className="h-full rounded-none bg-transparent hover:bg-slate-800 text-base ">
              Your Teams
            </Button>
            <Button className="h-full  rounded-none bg-transparent hover:bg-slate-800 text-base ">
              Following
        ...
        <div className="border-t-[0.5px] flex items-stretch space-x-2 border-b-[0.5px] py-4 px-3 border-slate-600  relative">
          <div className="flex flex-col w-full ">
            <div className="flex flex-row items-center">
              ...
              <input
                type="text"
                className="w-full h-full bg-transparent placeholder:text-2xl placeholder:text-gray-600 border-slate-600 p-4 outline-none border-none"
            ...
            <div className="w-full justify-between items-end flex">
              ...
              <div className="w-full max-w-[100px]">
                <Button className="text-base hover:bg-blue-600  hover:bg-opacity-80 bg-blue-500 px-6 py-2 rounded-full ">
                  Post
                </Button>
              </div>
            </div>
